...
namespace Unity.Robotics.Core
{
    public static class Clock
    {
        ...
        public enum ClockMode
        {
            ...
            // DateTimeNowUtc,
            // ExternalClock
            // Simulation time of messages sent
            Simulation,
        }

        public const double k_NanoSecondsInSeconds = 1e9;
        public const double k_MicroSecondsInSeconds = 1e-6; //?
        ...
        public static double FrameStartTimeInSeconds
        {
            get
            {
                return Mode switch
                {
                    ...
                    ClockMode.Simulation => GetSimulationTimeSec(),
                    _ => throw new NotImplementedException()
                };
            }
        }

        public static double GetSimulationTimeSec(){
            Double simulationTimeMicroSec = Connection.prev_simulation_time;
            return simulationTimeMicroSec * k_MicroSecondsInSeconds;
        }
