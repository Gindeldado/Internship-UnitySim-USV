...
namespace MavLink
{
	...
	public class Msg_trajectory_representation_waypoints : MavlinkMessage
    {
		...
		/// <summary>
		/// Acceptance radius of the waypoint
		/// </summary>
		public float[] accept_radius; // Array size 5
	...
	/// </summary>
	public class Msg_statustext_long : MavlinkMessage
    {
		...
		/// Status text message, without null termination character.
		/// </summary>
		public byte[] text; // Array size 254

        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_STATUSTEXT_LONG(this, bytes, ref offset);
            }        
	}
